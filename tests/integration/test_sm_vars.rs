...
fn pet_count_var_threshold() {
    ...
    r.update_env_vars(0.0, 0, String::new(), 1, 0.0, 1920.0, String::new());
    tick(&mut r, 100);
    assert!(
    ...
    r.update_env_vars(0.0, 0, String::new(), 2, 0.0, 1920.0, String::new());
    tick(&mut r, 100);
    assert!(
...
fn other_pet_dist_var_threshold() {
    ...
    r.update_env_vars(0.0, 0, String::new(), 1, 200.0, 1920.0, String::new());
    tick(&mut r, 100);
    assert!(
        matches!(&r.active, ActiveState::Named(n) if n == "idle"),
    ...
    r.update_env_vars(0.0, 0, String::new(), 1, 50.0, 1920.0, String::new());
    tick(&mut r, 100);
    assert!(
        matches!(&r.active, ActiveState::Named(n) if n == "sit"),
...
fn surface_label_var_string_match() {
    ...
    r.update_env_vars(0.0, 0, String::new(), 1, 0.0, 1920.0, "window".to_string());
    tick(&mut r, 100);
    assert!(
        matches!(&r.active, ActiveState::Named(n) if n == "idle"),
    ...
    r.update_env_vars(0.0, 0, String::new(), 1, 0.0, 1920.0, "taskbar".to_string());
    tick(&mut r, 100);
    assert!(
        matches!(&r.active, ActiveState::Named(n) if n == "sit"),
...
fn surface_w_var_threshold() {
    ...
    r.update_env_vars(0.0, 0, String::new(), 1, 0.0, 50.0, String::new());
    tick(&mut r, 100);
    assert!(
        matches!(&r.active, ActiveState::Named(n) if n == "idle"),
    ...
    r.update_env_vars(0.0, 0, String::new(), 1, 0.0, 200.0, String::new());
    tick(&mut r, 100);
    assert!(
        matches!(&r.active, ActiveState::Named(n) if n == "sit"),
...
fn cursor_dist_var_after_update() {
    ...
    r.update_env_vars(100.0, 0, String::new(), 1, 0.0, 1920.0, String::new());
    tick(&mut r, 100);
    assert!(
        matches!(&r.active, ActiveState::Named(n) if n == "idle"),
    ...
    r.update_env_vars(30.0, 0, String::new(), 1, 0.0, 1920.0, String::new());
    tick(&mut r, 100);
    assert!(
        matches!(&r.active, ActiveState::Named(n) if n == "sit"),
