...
- [ ] **M-01 — Touch support in webapp** (`crates/ferrite-webapp`) — egui/eframe touch events for drag, tap; test on mobile viewport
- [ ] **M-02 — Touch support in website** (`crates/ferrite-web`) — Dioxus site navigation and interactive elements usable on touch devices

---

## Website — Guides Pages

- [ ] **W-01 — Improve guides page visual design** (`crates/ferrite-web`) — layout, typography, spacing polish
- [ ] **W-02 — Add screenshots to guides** (`crates/ferrite-web`) — capture exact screenshots from webapp using Playwright (`tests/webapp/`), embed in guide pages
